...
urlpatterns = [
    ...
    path('departments/edit/<int:id>', views.DepartmentUpdateView.as_view(), name="update_departments"),
    path('departments/delete/<int:id>', views.DepartmentDeleteView.as_view(), name="delete_departments"),
    # ---- REPORTS ----
